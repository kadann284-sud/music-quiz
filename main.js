...
const SUPER_BEAVER_TOP10 = [
  "アイラヴユー","名前を呼ぶよ","らしさ","青い春","ありがとう",
  "美しい日","人として","ひなた","突破口","証明"
];

const SUPER_BEAVER_ALL = [
  "鼓動","風","電波","閃光","道標","運命","赤を塗って","贈りもの","誰か","証の歌","言えって","裸","歓声","前","虹","自慢になりたい","口","結果論","素晴らしい世界","約束。",
  "空の彼方","種の話","秘密","生活","生きがい","片想い","満員電車","深呼吸","涙の正体","決心","真ん中のこ","正攻法","歓びの明日に","東京流星群","東京","本音",
  "未来の話をしよう","未だ見ぬ明日へ","最前線","時代","星になりゆく人","日常サイクル","愛の愛の","愛する","愛しい人","心景","幻想","幸福軌道",
  "幸せのために生きているだけさ","小さな革命","嬉しい涙","始まる、未来","奪還","天気予報","境界線","地球軸","勇気の一歩","切望","全部","儚くない","僕の言葉",
  "今夜だけ","ホーム","人間","二人のこと","二つの旅路","予感","主人公","わたし","わたくしごと","ロマン","ルール","リフレイン","リビング","リセット","ラヴソング",
  "めくばせ","まわる、まわる","まなざし","まっしろ","まちがえた","まだ","まごころ","ほっといて","へその緒","ふらり","ふがいない夜こそ","ファンファーレ",
  "ひとりで生きていたならば","ひとつ","ひとこと","ひたむき","ヒカリ","パラドックス","はちきれそう","ハイライト","なんとなく","ドクターペッパー",
  "それでも世界が目を覚ますのなら","それっぽいふたり","それくらいのこと","その日を待つように","そして繋がる","センチメンタル","ゼロ距離","スペシャル","シンプリー",
  "じぶんまかせ","シアワセ","さよなら絶望","さよならも、ありがとう","ささやかな","サイン","サイレン","ことば","グラデーション","おかげさま","うるさい","あなた","アカネボシ",
  "VS.","Q&A","pan","mob","irony","ILP","how are you?","home","Hello, World","Goodbye","Cont'onroll","361°","318","27","×","→"
];

// 重複を潰して使う（表記ゆれはそのまま残すが、完全一致重複だけ排除）
const SUPER_BEAVER_ALL_UNIQ = [...new Set(SUPER_BEAVER_ALL)];
const SUPER_BEAVER_DEEP = SUPER_BEAVER_ALL_UNIQ.filter(t => !SUPER_BEAVER_TOP10.includes(t));
